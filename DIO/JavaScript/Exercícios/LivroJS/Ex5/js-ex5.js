...
function adicionarCarros() {
    ...
    // adicion dados ao vetor de objetos
    carros.push({ modelo: modelo, preco: preco });

    // limpa campos e posiciona o cursor em inModelo
    inModelo.value = "";
    inPreco.value = "";
    inModelo.focus();

    listarCarros(); // chama a function que lista os carros
...
function filtrarCarros() {
    ...
    // para concatenar a lista de carros que obedecem ao critério de pesquisa/filtro
    var lista = "";
