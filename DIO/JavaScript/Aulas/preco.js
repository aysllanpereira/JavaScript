function calcular () {
    ...
    if (formaPagamento === debito) {
        resultado.innerHTML = `O preço original do(a) ${produto} é R$${valor} e com o nosso desconto de 10% na forma de pagamento à vista/débito, fica por R$${valor - (valor * 0.1)}`;
    } else if (formaPagamento === dinheiroPix) {
        resultado.innerHTML = `O preço original do(a) ${produto} é R$${valor} e com o nosso desconto de 15% na forma de pagamento em dinheiro/pix, fica por R$${valor - (valor * 0.15)}`;
        ...
        resultado.innerHTML = `O preço original do(a) ${produto} é R$${valor} e na forma de pagamento parcelado em mais de 2x, fica o valor total de R$${valor + (valor * 0.1)}`
    }
